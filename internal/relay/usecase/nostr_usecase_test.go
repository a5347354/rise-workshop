...
import (
	"github.com/a5347354/rise-workshop/internal/event/mocks"
...
func Test_relayUsecase_ReceiveMessage_Event(t *testing.T) {
	Convey("ReceiveMessage Event", t, func() {
		...
		_, err := usecase.ReceiveMessage(context.TODO(), event)
		So(err, ShouldBeNil)
	})
}

func given(t *testing.T) (*mocks.MockStore, *relayUsecase) {
